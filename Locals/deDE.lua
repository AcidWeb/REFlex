...
REFlexLocale:CreateLocaleTable({
	...
	["Show Honorable Kills"] = "Zeige ehrenhafte Todesst\195\182\195\159e", -- Needs review
	...
	["Show amount of CPs to cap"] = "Zeige verbleibendes CP Limit", -- Needs review
