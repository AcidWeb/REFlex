...
function REFlex_GUIOnLoad(REPanel)
	...
	REFlex_GUI_MiniBarText:SetText(L["Show minibar (Battleground only)"]);
end
--
...
function REFlex_NumberCleanNegative(Number, round)
	if Number <= -1000000 then
		Number = REFlex_Round((Number / 1000000), round) .. "M";
	elseif Number <= -1000 then
		Number = REFlex_Round((Number / 1000), round) .. "K";
...
function REFlex_UpdateMiniBar()
	...
	elseif REMDamageD < 0 then
		if REMDamageD <= -1000000 then
			REMDamageD = "|cFFFF141D" .. REFlex_NumberCleanNegative(REMDamageD, 2) .. "|r"
		else
			REMDamageD = "|cFFFF141D" .. REFlex_NumberCleanNegative(REMDamageD, 0) .. "|r"
		end
	end
	...
	elseif REMHealingD < 0 then
		if REMHealingD <= -1000000 then
			REMHealingD = "|cFFFF141D" .. REFlex_NumberCleanNegative(REMHealingD, 2) .. "|r"
		else
			REMHealingD = "|cFFFF141D" .. REFlex_NumberCleanNegative(REMHealingD, 0) .. "|r"
		end
	end
